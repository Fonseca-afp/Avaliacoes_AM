...
def importar_marcor():
    """
    Função para importar os dados da Marcor.
    """
    # Lógica para importar os dados da Marcor e armazenar no DataFrame df
    
    # ler ficheiro csv com separador e decimal especificados
    df = pd.read_csv('/home/andre/projetos/Avaliacoes_AM/Avaliacoes_AM/dados/Tabelas_marcor.csv', sep=sep, decimal=decimal) 
...
def inserir_marcor(df):
    """
    Função para inserir os dados da Marcor no banco de dados.
    """
    ...
    with engine.connect() as connection:
        connection.execute(text(
                """
                INSERT INTO "Marcor" (sexo, segundos, nota)
